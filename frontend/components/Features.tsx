                ...
                <div className="border-t border-line">
                    {SECTORS.map((s, i) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="flex flex-col md:grid md:grid-cols-[80px_1fr_1fr] gap-6 md:gap-12 lg:gap-20 py-10 md:py-14 border-b border-line hover:bg-surface/60 transition-colors duration-300"
                        >
